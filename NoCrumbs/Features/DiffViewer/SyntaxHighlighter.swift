...
enum SyntaxHighlighter {
    ...
    private static func swiftGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"//.*$"#, t.commentColor),
                (#"/\*.*?\*/"#, t.commentColor),
    ...
    private static func pythonGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"#.*$"#, t.commentColor),
                (#"\"\"\"[\s\S]*?\"\"\""#, t.stringColor),
                ...
                (
                    #"\b(?:def|class|return|if|elif|else|for|while|break|continue|pass|import|from|as|try|except|finally|raise|with|yield|lambda|and|or|not|in|is|None|True|False|self|async|await|global|nonlocal|del|assert)\b"#,
                    t.keywordColor
                ),
                (#"\b[A-Z][A-Za-z0-9_]*\b"#, t.typeColor),
    ...
    private static func jsGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"//.*$"#, t.commentColor),
                (#"/\*.*?\*/"#, t.commentColor),
                ...
                (#"'(?:[^'\\]|\\.)*'"#, t.stringColor),
                (
                    #"\b(?:function|const|let|var|return|if|else|for|while|do|switch|case|default|break|continue|throw|try|catch|finally|new|delete|typeof|instanceof|in|of|class|extends|super|import|export|from|as|default|async|await|yield|this|null|undefined|true|false|void)\b"#,
                    t.keywordColor
                ),
                (#"\b[A-Z][A-Za-z0-9_]*\b"#, t.typeColor),
                (#"\b\d[\d_]*(?:\.\d[\d_]*)?(?:[eE][+-]?\d+)?\b"#, t.numberColor),
    ...
    private static func tsGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"//.*$"#, t.commentColor),
                (#"/\*.*?\*/"#, t.commentColor),
    ...
    private static func jsonGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
    ...
    private static func yamlGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"#.*$"#, t.commentColor),
                (#""(?:[^"\\]|\\.)*""#, t.stringColor),
    ...
    private static func markdownGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
    ...
    private static func shellGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"#.*$"#, t.commentColor),
                (#""(?:[^"\\]|\\.)*""#, t.stringColor),
                ...
                (
                    #"\b(?:if|then|elif|else|fi|for|while|do|done|case|esac|in|function|return|local|export|source|alias|unalias|set|unset|readonly|shift|exit|exec|eval|trap|wait|cd|echo|printf|read|test)\b"#,
                    t.keywordColor
                ),
            ]))
    }

    private static func rubyGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"#.*$"#, t.commentColor),
                (#""(?:[^"\\]|\\.)*""#, t.stringColor),
                ...
                (
                    #"\b(?:def|end|class|module|if|elsif|else|unless|for|while|until|do|begin|rescue|ensure|raise|return|yield|self|super|nil|true|false|require|include|extend|attr_accessor|attr_reader|attr_writer|puts|print)\b"#,
                    t.keywordColor
                ),
                (#"\b[A-Z][A-Za-z0-9_]*\b"#, t.typeColor),
                (#"\b\d+(?:\.\d+)?\b"#, t.numberColor),
    ...
    private static func goGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"//.*$"#, t.commentColor),
                (#"/\*.*?\*/"#, t.commentColor),
                ...
                (#""(?:[^"\\]|\\.)*""#, t.stringColor),
                (
                    #"\b(?:func|var|const|type|struct|interface|map|chan|go|select|switch|case|default|if|else|for|range|return|break|continue|goto|fallthrough|defer|package|import|nil|true|false|iota|make|new|len|cap|append|copy|delete|close|panic|recover)\b"#,
                    t.keywordColor
                ),
                (
                    #"\b(?:int|int8|int16|int32|int64|uint|uint8|uint16|uint32|uint64|float32|float64|complex64|complex128|string|bool|byte|rune|error|any)\b"#,
                    t.typeColor
                ),
                (#"\b[A-Z][A-Za-z0-9_]*\b"#, t.typeColor),
                (#"\b\d[\d_]*(?:\.\d[\d_]*)?(?:[eE][+-]?\d+)?\b"#, t.numberColor),
    ...
    private static func rustGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"//.*$"#, t.commentColor),
                (#"/\*.*?\*/"#, t.commentColor),
                ...
                (
                    #"\b(?:fn|let|mut|const|static|struct|enum|impl|trait|type|pub|crate|mod|use|as|self|Self|super|return|if|else|match|for|while|loop|break|continue|move|ref|where|async|await|unsafe|extern|dyn|true|false)\b"#,
                    t.keywordColor
                ),
    ...
    private static func cGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"//.*$"#, t.commentColor),
                (#"/\*.*?\*/"#, t.commentColor),
                ...
                (
                    #"\b(?:auto|break|case|char|const|continue|default|do|double|else|enum|extern|float|for|goto|if|inline|int|long|register|return|short|signed|sizeof|static|struct|switch|typedef|union|unsigned|void|volatile|while|NULL)\b"#,
                    t.keywordColor
                ),
    ...
    private static func cppGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"//.*$"#, t.commentColor),
                (#"/\*.*?\*/"#, t.commentColor),
    ...
    private static func javaGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"//.*$"#, t.commentColor),
                (#"/\*.*?\*/"#, t.commentColor),
    ...
    private static func cssGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"/\*.*?\*/"#, t.commentColor),
                (#""(?:[^"\\]|\\.)*""#, t.stringColor),
    ...
    private static func htmlGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"<!--.*?-->"#, t.commentColor),
                (#""(?:[^"\\]|\\.)*""#, t.stringColor),
    ...
    private static func sqlGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"--.*$"#, t.commentColor),
                (#"/\*.*?\*/"#, t.commentColor),
    ...
    private static func tomlGrammar(_ t: DiffTheme) -> Grammar {
        Grammar(
            rules: rules([
                (#"#.*$"#, t.commentColor),
                (#""""[\s\S]*?""""#, t.stringColor),
